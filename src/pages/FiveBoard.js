...
import "../App.css";
import Board from "../components/FiveLetter/Board.js";
import Keyboard from "../components/FiveLetter/Keyboard.js";
import GameOver from "../components/FiveLetter/GameOver.js";
import BoardButtons from "../components/BoardButtons.js";
import { boardDefault, generateFiveWordSet } from "../Words.js";
...
function FiveBoard() {
  ...
  useEffect(() => {
    generateFiveWordSet().then((words) => {
